...
class Item(Entity):
    ...
    # Class constructor
    def __init__(self, name, x, y, width, height, color, points, effects = ()):
...
class Obstacle(Entity):
    ...
    # Class constructor
    def __init__(self, name, x, y, width, height, color, damage, lost_points, knockout_time, image=None):
...
class Tsunami(Obstacle):
    ...
    def __init__(self, name, x, y, width, height, color, speed, delay):
        super().__init__(name, x, y, width, height, color, 9999, 0, 0)
